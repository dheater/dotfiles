...
INSERT INTO cfg_property (propvalue, propname) VALUES ('***REMOVED***', 'mail.smtp.password');
...
INSERT INTO cfg_property (propvalue, propname) VALUES ('***REMOVED***', 'mail.smtp.user');
...
UPDATE cfg_user SET adminUser=1, status=0, datePasswordChanged=now(), dateLastActive=now(), passwd=md5('***REMOVED***')  WHERE userId ilike 'securelink';
